...

{
...

    {
        ...
        group.MapPost("/committee-decisions/{id:guid}/submit", Submit).RequirePermission(PermissionKeys.CommitteeDecisionsSubmit);

        group.MapPost("/committee-decisions/{id:guid}/approve", Approve).RequirePermission(PermissionKeys.CommitteeDecisionsApprove);

        group.MapPost("/committee-decisions/{id:guid}/reject", Reject).RequirePermission(PermissionKeys.CommitteeDecisionsReject);

        group.MapPost("/committee-decisions/{id:guid}/suspend", Suspend).RequirePermission(PermissionKeys.CommitteeDecisionsApprove);

        group.MapPost("/committee-decisions/{id:guid}/cancel", Cancel).RequirePermission(PermissionKeys.CommitteeDecisionsCancel);
...

    {
        ...
        var result = await service.ListAsync(GetOrgId(httpContext), GetAuth(httpContext), cancellationToken);
